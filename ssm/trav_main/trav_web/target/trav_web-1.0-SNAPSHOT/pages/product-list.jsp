...
<body class="hold-transition skin-blue sidebar-mini">
						...
						<table id="dataList"
							...
							<tbody>
								...
								<tr>
									...
									<td>
										<%--格式化数值--%>
										<%--格式：0.00, 表示不够2位会自动补0；自动四舍五入--%>
										<%--格式：#.##, 不够2位不会自动补0；自动四舍五入--%>
									...
									<td class="text-center">
										<button type="button" class="btn bg-olive btn-xs"
											onclick='location.href="/product/findById?id=${p.id}"'>修改</button>
										<button type="button" class="btn bg-olive btn-xs"
				...
				<div class="box-footer">
					...
					<div class="box-tools pull-right">
						<ul class="pagination">
							...
							<li><a href="/product/findByPage?pageNum=${pb.pageNum-1}">上一页</a></li>
							<li><a href="#">1</a></li>
							<li><a href="#">2</a></li>
							<li><a href="#">3</a></li>
							<li><a href="#">4</a></li>
							<li><a href="#">5</a></li>
							<li><a href="/product/findByPage?pageNum=${pb.pageNum+1}">下一页</a></li>
							<li><a href="/product/findByPage?pageNum=${pb.totalPage}" aria-label="Next">尾页</a></li>
						</ul>
					</div>
	...
	<script>
        ...
        function deleteProduct(){
			//1. 获取选中的复选框
			var chx = $("input[name='ids'][type='checkbox']:checked");
            ...
            /**
			 * 4. 遍历选中的复选框(chx)
			 * jQuery提供的each()函数，用于遍历集合值。
			 * 1. 语法
			 *  $.each(遍历的集合,function(){});
			 * 2. 举例：
			 	$.each([1,2,55,66],function(){
                	alert(this);
				})
             */
			$.each(chx,function(){
			    // this 表示当前遍历的每一个元素，是一个checkbox
				//productIds += this.value + ",";

				//$(this) 把一个dom元素转换为jQuery对象，这样就可以使用jQuery对象的方法
				productIds += $(this).val() + ",";
			});
			//5. 截取去掉最后一个逗号
